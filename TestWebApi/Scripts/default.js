        ...
        if (xhr.readyState == 4 && xhr.status == 200) {
            ...
            if (resp.length == 0) {
                ...
                if (headerList.innerHTML.length == 0) {
                    headerList.innerHTML = '<tr><th><span id="thName" onclick="Sorting(this)">Name</span></th><th><span id="thSurname" onclick="Sorting(this)">Surname<i id="icon" class="icon-chevron-down icon-white"/></span></th><th><span id="thPatronymic"onclick="Sorting(this)">Patronymic</span></th><th><span id="thPassportNumber"onclick="Sorting(this)">Passport number</span></th><th><span id="thSex"onclick="Sorting(this)">Sex</span></th><th><span id="thBirthday"onclick="Sorting(this)">Birthday</span></th><th><span id="thCity"onclick="Sorting(this)">City</span></th><th><span id="thAddress"onclick="Sorting(this)">Address</span></th><th><span id="thIssuedBy"onclick="Sorting(this)">Issued by</span></th><th><span id="thDateOfIssue"onclick="Sorting(this)">Date of issue</span></th><th><span id="thCode"onclick="Sorting(this)">Code</span></th></tr>';
                }
